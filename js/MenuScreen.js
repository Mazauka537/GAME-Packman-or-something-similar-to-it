class MenuScreen {
    constructor(game) {
        ...
        this.settingsButtons = [
            ...
            this.createSettingsButton('left', this.game.settings.p1Control.left, 370, () => this.btnControlChangeClick(1, 'p1Control', 'left')),
            this.createSettingsButton('right', this.game.settings.p1Control.right, 420, () => this.btnControlChangeClick(2, 'p1Control', 'right')),
            this.createSettingsButton('up', this.game.settings.p1Control.up, 470, () => this.btnControlChangeClick(3, 'p1Control', 'up')),
            this.createSettingsButton('down', this.game.settings.p1Control.down, 520, () => this.btnControlChangeClick(4, 'p1Control', 'down')),
            this.createSettingsButton('left', this.game.settings.p2Control.left, 640, () => this.btnControlChangeClick(5, 'p2Control', 'left')),
            this.createSettingsButton('right', this.game.settings.p2Control.right, 690, () => this.btnControlChangeClick(6, 'p2Control', 'right')),
            this.createSettingsButton('up', this.game.settings.p2Control.up, 740, () => this.btnControlChangeClick(7, 'p2Control', 'up')),
            this.createSettingsButton('down', this.game.settings.p2Control.down, 790, () => this.btnControlChangeClick(8, 'p2Control', 'down')),
        ];
